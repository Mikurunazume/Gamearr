            ...
            <CardHeader>
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <CardDescription>
                            Map IGDB Platform IDs to RomM folder names (slugs).
                        </CardDescription>
                    </div>
                    <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => initDefaultsMutation.mutate()} disabled={initDefaultsMutation.isPending}>
                            {initDefaultsMutation.isPending ? <Loader2 className="h-4 w-4 animate-spin" /> : <RefreshCw className="h-4 w-4" />}
                            Init Defaults
                        </Button>
                                ...
                                <div className="space-y-4 py-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={e => setNewMapping({ ...newMapping, igdbPlatformId: e.target.value })}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={e => setNewMapping({ ...newMapping, rommPlatformName: e.target.value })}
                                        />
                                    </div>
            ...
            <CardContent>
                <Table>
                    ...
                    <TableBody>
                        {mappings?.length === 0 && (
                            <TableRow>
                                <TableCell colSpan={3} className="text-center text-muted-foreground">No mappings defined</TableCell>
                            </TableRow>
                        )}
